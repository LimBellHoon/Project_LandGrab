namespace Client
{
    ...
    public enum SKILL_TYPE
    {
        ...
        // 260923_쾌속 돌진. 지금 향한 방향으로 몬스터 · 맵 끝 · 내 점령지 중 처음 닿는 곳까지 한 번에 간다.
        RUSH,
    }
    ...
    public enum CARD_TYPE
    {
        ...
        // 260923_사냥형 8종(Docs/Design_Card_Pool.md 1장) — 몸으로 부딪히는 것을 공격 기회로 바꾼다.
        HUNT_THORN,      // 가시 갑옷 — 몸 충돌한 몬스터에게 고정 피해
        HUNT_KNOCKBACK,  // 거센 팔뚝 — 넉백 거리 배율 가산
        HUNT_STONESKIN,  // 돌가죽 — 몸 충돌 피해 배율(곱해서 누적)
        HUNT_TAUNT,      // 도발 — 몸 충돌마다 분노 게이지를 추가로 올린다
        HUNT_MARK,       // 사냥감 표식 — 넉백당한 몬스터가 잠깐 감속
